...
import com.senai.diario_de_classe.data.worker.UsuarioSyncScheduler
...
class UsuarioRepository @Inject constructor(
    ...
    private  fun partJsonDados (dados:Any): RequestBoby =
        gson.toJson(dados).toResquestBoby(jsonMedia)
